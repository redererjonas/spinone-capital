  ...
  const bondTypes = [
    {
      ...
      description: 'Anleihen von Staaten mit hoher Bonität bieten maximale Sicherheit. Deutsche Bundesanleihen, US-Treasuries und andere AAA-geratete Staatsanleihen bilden das Fundament sicherer Portfolios.',
      features: ['Höchste Bonität (AAA bis A)', 'Maximale Sicherheit', 'Hohe Liquidität']
    },
    {
      icon: 'ri-building-line',
      title: 'Unternehmensanleihen',
      description: 'Corporate Bonds von erstklassigen Unternehmen bieten höhere Renditen bei kontrolliertem Risiko. Sorgfältige Bonitätsprüfung und Diversifikation sind entscheidend.',
      features: ['Investment Grade (BBB+ bis AAA)', 'Höhere Renditen', 'Breite Diversifikation']
    },
    {
      icon: 'ri-bank-line',
      title: 'Pfandbriefe',
      description: 'Deutsche Pfandbriefe gelten als besonders sichere Anleihen. Durch Immobilien oder öffentliche Kredite besichert, bieten sie attraktive Renditen bei hoher Sicherheit.',
      features: ['Besicherte Anleihen', 'Hohe Sicherheit', 'Attraktive Renditen']
    },
    {
      icon: 'ri-leaf-line',
      title: 'Green Bonds',
      description: 'Nachhaltige Anleihen finanzieren Umwelt- und Klimaprojekte. Kombinieren Sie finanzielle Rendite mit positivem Impact für eine nachhaltige Zukunft.',
      features: ['ESG-konform', 'Positive Wirkung', 'Wachsender Markt']
    }
  ];

  const investmentStrategy = [
    { icon: 'ri-search-eye-line', title: 'Bonitätsanalyse', description: 'Gründliche Prüfung der Kreditwürdigkeit aller Emittenten. Nur Anleihen mit ausreichender Bonität werden ins Portfolio aufgenommen.' },
    { icon: 'ri-time-line', title: 'Duration-Management', description: 'Aktive Steuerung der Zinssensitivität durch gezielte Auswahl von Laufzeiten. Anpassung an Zinserwartungen und Marktbedingungen.' },
    { icon: 'ri-pie-chart-line', title: 'Diversifikation', description: 'Breite Streuung über Emittenten, Branchen, Länder und Laufzeiten. Minimierung von Klumpenrisiken für stabile Portfolios.' }
  ];
    ...
    <div className="min-h-screen bg-white bg-filigree">
      ...
      <section className="relative min-h-[70vh] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-accent-pink/5 rounded-full blur-[120px] animate-pulse"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          ...
          >
            <div className="inline-flex items-center space-x-2 glass-effect px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-semibold text-slate-700">Anleihen</span>
            </div>
            ...
            <p className="text-xl text-slate-600 mb-8 max-w-2xl">
              Professionelles Fixed Income Management für institutionelle Investoren. Staatsanleihen und Unternehmensanleihen mit systematischer Risikosteuerung für stabile Portfolios.
            </p>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-20 right-10 w-72 h-72 bg-accent-pink/5 rounded-full blur-[100px] animate-pulse"></div>
          <div className="absolute bottom-20 left-10 w-72 h-72 bg-primary-500/5 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '1s' }}></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-accent-pink to-accent-pink-dark rounded-2xl mb-6 shadow-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <h3 className="text-2xl font-heading font-bold text-slate-900 mb-8">Anleihen-Parameter</h3>

              <div className="space-y-8">
                {/* Bond Type Selection */}
                <div>
                  <label className="text-sm font-semibold text-slate-600 mb-4 block">Anleihentyp</label>
                ...
                <div>
                  <div className="flex justify-between items-center mb-4">
                    <label className="text-sm font-semibold text-slate-600">Nominalbetrag</label>
                  ...
                  <input
                    ...
                    className="w-full h-3 bg-slate-200 rounded-full appearance-none cursor-pointer accent-accent-pink"
                  />
                ...
                <div>
                  <div className="flex justify-between items-center mb-4">
                    <label className="text-sm font-semibold text-slate-600">Kupon (Zinssatz p.a.)</label>
                ...
                <div>
                  <div className="flex justify-between items-center mb-4">
                    <label className="text-sm font-semibold text-slate-600">Restlaufzeit</label>
                ...
                <div>
                  <div className="flex justify-between items-center mb-4">
                    <label className="text-sm font-semibold text-slate-600">Kaufkurs (% vom Nennwert)</label>
              ...
              <div className="mt-8 glass-effect rounded-2xl p-6">
                <div className="flex items-start space-x-4">
                  <div className="w-10 h-10 bg-primary-500/5 rounded-xl flex items-center justify-center flex-shrink-0">
                    <i className="ri-information-line text-xl text-primary-400"></i>
                  </div>
                  <div>
                    <h4 className="font-semibold text-slate-900 mb-2">{bondTypeInfo[calculatorData.bondType]?.name}</h4>
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <div className="relative overflow-hidden rounded-3xl p-8 bg-gradient-to-br from-accent-pink via-accent-pink-dark to-accent-purple shadow-lg">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-6">
                    <div>
                      <p className="text-slate-600 text-sm mb-2">Gesamtertrag nach {calculatorData.years} Jahren</p>
                      <p className="text-5xl font-bold text-slate-900">{result.totalReturn.toLocaleString('de-DE', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} EUR</p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      <div>
                        <p className="text-slate-600 text-sm mb-2">Kuponzahlungen</p>
                      ...
                      <div>
                        <p className="text-slate-600 text-sm mb-2">Kursgewinn/-verlust</p>
                    ...
                    <div>
                      <p className="text-slate-600 text-sm mb-2">Effektivverzinsung (Yield to Maturity)</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="glass-card p-6">
                  <div className="w-12 h-12 bg-accent-pink/5 rounded-xl flex items-center justify-center mb-4">
                    <i className="ri-calendar-check-line text-2xl text-accent-pink"></i>
                  </div>
                  <p className="text-sm text-slate-500 mb-2">Jährlicher Kupon</p>
                  <p className="text-2xl font-bold text-slate-900">{result.annualCoupon.toLocaleString('de-DE', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} EUR</p>
                </div>
                ...
                <div className="glass-card p-6">
                  ...
                  <p className="text-sm text-slate-500 mb-2">Rückzahlungswert</p>
                  <p className="text-2xl font-bold text-slate-900">{result.redemptionValue.toLocaleString('de-DE', { minimumFractionDigits: 0, maximumFractionDigits: 0 })} EUR</p>
                </div>
              </div>

              <div className="glass-card p-6">
                <h4 className="font-semibold text-slate-900 mb-4">Investitionsübersicht</h4>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-500">Kaufpreis</span>
                    <span className="font-bold text-slate-900">{result.purchaseCost.toLocaleString('de-DE', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} EUR</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-500">Nominalbetrag</span>
                    <span className="font-bold text-slate-900">{calculatorData.bondAmount.toLocaleString('de-DE')} EUR</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-500">Laufzeit</span>
                    <span className="font-bold text-slate-900">{calculatorData.years} Jahre</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-500">Kupon</span>
                    <span className="font-bold text-slate-900">{calculatorData.couponRate.toFixed(2)} % p.a.</span>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-card p-6 border-l-4 border-success">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-900 mb-2">Kurs und Rendite</h4>
                    <p className="text-sm text-slate-500 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {bondTypes.map((bond, index) => (
              ...
              >
                <div className="w-14 h-14 bg-gradient-to-br from-accent-pink to-accent-pink-dark rounded-xl flex items-center justify-center mb-6 shadow-lg">
                  <i className={`${bond.icon} text-2xl text-white`}></i>
                </div>
                <h3 className="text-2xl font-heading font-bold text-slate-900 mb-4">{bond.title}</h3>
                <p className="text-slate-500 leading-relaxed mb-6">{bond.description}</p>
                <ul className="space-y-2">
                  {bond.features.map((feature, fIndex) => (
                    <li key={fIndex} className="flex items-center space-x-2 text-slate-500">
      ...
      <section className="relative py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-heading font-bold text-slate-900 mb-6">
              Für wen sind <span className="gradient-text-warm">Anleihen</span> geeignet?
            </h2>
            <p className="text-xl text-slate-500 max-w-3xl mx-auto">
              Entdecken Sie, ob Anleihen die richtige Anlageform für Sie sind
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {targetGroups.map((group, index) => (
              ...
              >
                <div className="w-16 h-16 bg-gradient-to-br from-accent-pink to-accent-pink-dark rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg">
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                    ...
                    risk.level === 'Niedrig bis Mittel' ? 'bg-accent-cyan/10 text-accent-cyan' :
                    risk.level === 'Mittel' ? 'bg-highlight/10 text-highlight' :
                    risk.level === 'Mittel bis Hoch' ? 'bg-highlight/10 text-highlight' :
                    'bg-accent-pink/5 text-accent-pink'
                  }`}>
                    {risk.level}
                  </span>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {investmentStrategy.map((item, index) => (
              ...
              >
                <div className="w-16 h-16 bg-gradient-to-br from-accent-pink to-accent-pink-dark rounded-2xl flex items-center justify-center mb-6 mx-auto shadow-lg">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-slate-500 mb-8 max-w-2xl mx-auto">
                Erfahren Sie mehr über unsere Fixed Income Strategien und wie wir stabile Erträge für Ihr Portfolio generieren.
              </p>
