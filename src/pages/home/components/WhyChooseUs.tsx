  ...
  const reasons = [
    {
      ...
      description: 'Vollstandig reguliert nach Paragraph 44 iVm Paragraph 2 Abs.4 KAGB. Hochste Compliance-Standards und transparente Governance-Strukturen fur Ihre Sicherheit.',
    ...
    },
    {
      ...
      description: 'Uber 15 Jahre kombinierte Kapitalmarkterfahrung. Unser Expertenteam verfugt uber tiefgreifende Kenntnisse in allen Anlageklassen.',
    ...
    },
    {
      ...
      title: 'Personliche Betreuung',
      description: 'Dedizierte Ansprechpartner fur alle Ihre Anliegen. Individuelle Beratung und massgeschneiderte Losungen fur Ihre Anlageziele.',
    ...
    },
    {
      ...
      description: 'Strenge Sicherheitsprotokolle und Risikomanagement-Systeme. Ihre Vermogenswerte sind durch umfassende Sicherheitsmassnahmen geschutzt.',
    ...
    },
    {
      ...
      description: 'Zugang zu internationalen Markten und Anlageklassen. Profitieren Sie von globalen Investmentchancen mit lokaler Expertise.',
      stats: { value: '25+', label: 'Markte' },
      color: '#EF4444',
      colorEnd: '#F87171',
      glowColor: '239, 68, 68'
    }
    ...
    <section className="relative py-24 bg-[#020617] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <motion.div
          ...
          className="absolute -top-1/4 right-0 w-[700px] h-[700px] bg-[#6366F1] rounded-full blur-[250px]"
        />
        <motion.div
          animate={{ scale: [1.2, 1, 1.2], opacity: [0.2, 0.3, 0.2] }}
          transition={{ duration: 15, repeat: Infinity, ease: "easeInOut", delay: 2 }}
          className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#EC4899] rounded-full blur-[250px]"
        />
        {/* Grid Pattern */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-bold text-white/90 uppercase tracking-wider">Warum SPINONE CAPITAL</span>
          </motion.div>
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Ihr Partner fur{' '}
            <span className="bg-gradient-to-r from-[#6366F1] via-[#A855F7] to-[#EC4899] bg-clip-text text-transparent">
              professionelles Vermogensmanagement
            </span>
          </h2>
        ...
        >
          {reasons.map((reason, index) => (
            <motion.div
              ...
              style={{
                boxShadow: `0 0 60px rgba(${reason.glowColor}, 0.1)`,
              }}
            >
              {/* Hover Glow Overlay */}
              <div
                className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                style={{ background: `linear-gradient(135deg, ${reason.color}15, transparent)` }}
              />
              ...
              <div className="absolute top-6 right-6">
                <div
                  className="backdrop-blur-xl rounded-xl px-4 py-2 border border-white/10"
                ...
                >
                  ...
                  <p className="text-xs text-white/60 font-semibold">{reason.stats.label}</p>
                </div>
              </div>
