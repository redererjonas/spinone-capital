    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50 to-purple-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            <div className="mb-8">
              <div className="w-32 h-32 mx-auto bg-gradient-to-br from-cyan-500 via-blue-500 to-emerald-500 rounded-3xl flex items-center justify-center shadow-2xl transform -rotate-3 hover:rotate-0 transition-transform duration-500">
            ...
            >
              <div className="flex items-center justify-center gap-3 mb-8">
                <div className="w-12 h-12 bg-gradient-to-br from-cyan-500 to-emerald-600 rounded-xl flex items-center justify-center shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-2xl p-6 border border-emerald-200">
                  ...
                  <h3 className="font-bold text-emerald-600 mb-2 text-lg">Sofortige Verfugbarkeit</h3>
                ...
                <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-2xl p-6 border border-cyan-200">
                  ...
                  <h3 className="font-bold text-cyan-600 mb-2 text-lg">Variable Zinsen</h3>
                ...
                <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-6 border border-indigo-200">
                  ...
                  <h3 className="font-bold text-indigo-600 mb-2 text-lg">Keine Mindestanlage</h3>
                  <p className="text-sm text-slate-500">Starten Sie bereits mit kleinen Betragen</p>
                </div>
              </div>

              <div className="bg-gradient-to-br from-cyan-600 via-blue-600 to-emerald-600 rounded-2xl p-8 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white/80 mb-6 text-lg">
                    Kontaktieren Sie uns fur eine personliche Beratung. Wir helfen Ihnen gerne, Ihre Liquiditatsreserve optimal anzulegen.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <a
                      href="tel:+4940334668098"
                      className="inline-flex items-center justify-center gap-3 bg-white text-cyan-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-slate-100 transition-all shadow-lg"
                    >
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-3 bg-emerald-500 hover:bg-emerald-400 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all shadow-lg cursor-pointer"
                    >
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50 to-purple-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <span className="text-cyan-600 font-semibold">Tagesgeld</span>
        </motion.div>
        ...
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-gradient-to-br from-cyan-600 via-blue-600 to-emerald-600 rounded-3xl p-8 md:p-10 text-white shadow-2xl mb-8 relative overflow-hidden"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-slate-500">Kontoeroffnung:</span>
                  <span className="font-semibold text-slate-800">{investment.startDate}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-500">Tage seit Eroffnung:</span>
                  <span className="font-semibold text-emerald-600">{daysSinceStart} Tage</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-500">Verfugbarkeit:</span>
                  <span className="font-semibold text-emerald-600">Sofort</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-500">Kundigungsfrist:</span>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-slate-500">
                      Ihr Geld ist taglich verfugbar. Sie konnen jederzeit Ein- und Auszahlungen vornehmen, ohne Kundigungsfristen oder Gebuhren.
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-cyan-50 rounded-xl p-4 border border-cyan-200">
                  ...
                  <p className="text-2xl font-bold text-cyan-600">{investment.profit.toLocaleString('de-DE')} EUR</p>
                </div>
                <div className="bg-purple-50 rounded-xl p-4 border border-purple-200">
                  <p className="text-sm text-slate-500 mb-1">Monatlicher Zins</p>
                  <p className="text-2xl font-bold text-purple-600">{(investment.profit / (daysSinceStart / 30)).toFixed(2)} EUR</p>
                </div>
                <div className="bg-amber-50 rounded-xl p-4 border border-amber-200">
                  <p className="text-sm text-slate-500 mb-1">Taglicher Zins</p>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                ...
                <div className="border border-slate-200 rounded-xl p-4">
                  <p className="text-sm text-slate-500 mb-1">Nachste Gutschrift</p>
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-4 bg-cyan-50 rounded-xl border border-cyan-200">
                  ...
                  <span className="font-bold text-cyan-600">+{(investment.profit / (daysSinceStart / 30)).toFixed(2)} EUR</span>
                </div>
              </div>
          ...
          <div className="space-y-6">
            <motion.div
              ...
              className="bg-white shadow-lg border border-slate-200 rounded-2xl p-6"
            >
              <h3 className="text-lg font-heading font-bold text-slate-800 mb-4">Schnellubersicht</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-slate-500">Verfugbarkeit</p>
            ...
            >
              ...
              <div className="space-y-3">
                <button
                  onClick={() => setShowCallModal(true)}
                  className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white py-3 px-4 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2 cursor-pointer"
                >
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-slate-800 mb-2">Maximale Flexibilitat</h3>
                  <p className="text-sm text-slate-500">
                    Tagesgeld bietet Ihnen hochste Flexibilitat bei attraktiven Zinsen. Perfekt fur Ihre Liquiditatsreserve.
                  </p>
                </div>
              </div>
            </motion.div>
