            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div className="bg-gradient-to-br from-blue-50 to-sky-50 rounded-2xl p-6 border border-blue-200">
                  ...
                  <h3 className="font-bold text-blue-600 mb-2 text-lg">Hohe Renditechancen</h3>
                  <p className="text-sm text-slate-500">Langfristig überdurchschnittliche Ertragsmöglichkeiten</p>
                </div>
                <div className="bg-gradient-to-br from-sky-50 to-blue-50 rounded-2xl p-6 border border-sky-200">
                  ...
                  <h3 className="font-bold text-blue-600 mb-2 text-lg">Diversifikation</h3>
                  <p className="text-sm text-slate-500">Risikostreuung über verschiedene Branchen</p>
                </div>
                <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-2xl p-6 border border-emerald-200">
                  ...
                  <p className="text-sm text-slate-500">Regelmäßige Gewinnausschüttungen</p>
                </div>
              </div>
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <span className="text-blue-600 font-semibold">Aktien</span>
        </motion.div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b-2 border-slate-200">
                      ...
                      <th className="text-right py-4 px-4 text-sm font-bold text-slate-500">Änderung</th>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-gradient-to-br from-blue-50 to-sky-50 rounded-xl p-5 border border-blue-200">
                  <p className="text-sm text-blue-600 mb-2 font-medium">Tägliche Rendite</p>
                  <p className="text-xl font-bold text-slate-800">
                    +{dailyReturn.toLocaleString('de-DE', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} EUR
                  </p>
                </div>
                <div className="bg-gradient-to-br from-blue-50 to-sky-50 rounded-xl p-5 border border-blue-200">
                  <p className="text-sm text-blue-600 mb-2 font-medium">Monatliche Rendite</p>
                  <p className="text-xl font-bold text-slate-800">
              ...
              <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-800 mb-2">Marktübersicht</h3>
                  ...
                  <tbody>
                    {monthlyHistory.map((item, index) => (
                      ...
                      >
                        <td className="py-4 px-4">
                          <div className="flex items-center gap-3">
                            <div className="w-8 h-8 bg-gradient-to-br from-blue-600 to-blue-700 rounded-lg flex items-center justify-center text-white text-xs font-bold shadow-md">
                              {index + 1}
                            </div>
                        ...
                        <td className={`py-4 px-4 text-right font-bold ${item.percentage >= 0 ? 'text-blue-600' : 'text-red-500'}`}>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-3 border-b border-slate-200">
                  ...
                  <span className="font-bold text-blue-600">Aktien</span>
                </div>
                <div className="flex items-center justify-between py-3 border-b border-slate-200">
